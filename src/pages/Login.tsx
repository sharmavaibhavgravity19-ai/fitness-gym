      ...
      >
        <div className="glass-card p-10 rounded-[2.5rem] border-neon-green/20">
          <div className="text-center mb-10">
            ...
            <h1 className="text-3xl font-display font-black uppercase italic mb-2">Welcome Back</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button variant="neon" size="lg" className="w-full" isLoading={isLoading}>
              Sign In
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-400">
              ...
              <Link to="/signup" className="text-neon-green font-bold hover:underline">
                Join Now
              </Link>
            </p>
          </div>
          ...
          <div className="mt-6 pt-6 border-t border-dark-border text-center">
            <Link to="/admin" className="text-xs text-gray-500 hover:text-gray-300">
